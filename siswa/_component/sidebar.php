...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0" href="index.php">
            <span class="font-weight-bold text-lg">Dashboard Panel</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <a class="d-flex align-items-center nav-link" data-bs-toggle="collapse" href="#accountPagesCollapse"
                    ...
                    <span class="font-weight-normal text-md ms-2">Ekstrakulikuler</span>
                </a>
                <div class="collapse ps-4 <?= in_array($current_page, ['ekstrakulikuler.php', 'my-ekstrakulikuler.php']) ? 'show' : '' ?>"
                    id="accountPagesCollapse">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link <?= $current_page == 'ekstrakulikuler.php' ? 'active' : '' ?>"
                                href="ekstrakulikuler.php">
                                <span class="sidenav-normal">List Ekstrakulikuler</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $current_page == 'my-ekstrakulikuler.php' ? 'active' : '' ?>"
                                href="my-ekstrakulikuler.php">
                                <span class="sidenav-normal">My Ekstrakulikuler</span>
                            </a>
                        </li>
                    </ul>
                </div>
