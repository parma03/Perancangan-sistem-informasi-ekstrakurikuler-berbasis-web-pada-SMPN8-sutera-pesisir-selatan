...
<body class="g-sidenav-show bg-gray-100">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center px-2 py-1">
                                                        <?php if ($data["siswa_profile"] === NULL) { ?>
                                                            <div class="trans-logo bg-gray-100 me-3">
                                                                <img src="../assets/img/team-2.jpg" class="w-75" alt="xd">
                                                            </div>
                                                        <?php } else { ?>
                                                            <div class="trans-logo bg-gray-100 me-3">
                                                                <img src="../assets/img/profile/<?php echo $data["siswa_profile"]; ?>"
                                                                    class="w-75" alt="xd">
                                                            </div>
                                                        <?php } ?>
                                                        <div>
                                                ...
                                                <td>
                                                    <p class="transaction-amount mb-0"><?php echo $data["siswa_nama"] ?>
                                                    </p>
                                                </td>
                                                                    ...
                                                                    <div class="card border-0 shadow-sm">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="row mb-2">
                                                                                ...
                                                                                <div class="col-8">
                                                                                    <?php echo htmlspecialchars($data["siswa_nama"]); ?>
                                                                                </div>
                                                                            </div>
                                                                            <hr class="my-2">
                                                                            <div class="row mb-2">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <center>
                                                            <div class="col-md-3">
                                                                ...
                                                                <?php } else { ?>
                                                                    <img class="card-img card-img-center align-items-center"
                                                                        src="../assets/img/profile/<?php echo $data["siswa_profile"]; ?>" />
                                                                <?php } ?>
                                                            </div>
                                                        </center>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" id="nama"
                                                                        name="nama"
                                                                        value="<?php echo $data["siswa_nama"] ?>" required>
                                                                </div>
                                                                <div class="mb-3">
    ...
    <div class="modal fade" id="modalAddAdmin" tabindex="-1" aria-labelledby="modalAddAdminLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAddAdminLabel">Tambah Data Siswa</h5>
